...
```sh
gh attestation verify FILE --repo faratech/fwdslash --predicate-type https://faratech.dev/attestations/windows-release-verification/v1 --signer-workflow faratech/fwdslash/.github/workflows/attest-existing-release.yml
```
